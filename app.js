...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.blog-card, .project-card');
    ...
    // Blog card and project card enhanced interactions
    const interactiveCards = document.querySelectorAll('.blog-card, .project-card');
    ...
    const lazyAnimations = document.querySelectorAll('.skill-tag, .tech-tag');
    ...
    if (copyrightElement) {
        copyrightElement.textContent = `© ${currentYear} Aditya Singh | Cybersecurity Portfolio`;
    }
});
